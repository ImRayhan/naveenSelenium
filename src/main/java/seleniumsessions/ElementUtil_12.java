...
public class ElementUtil_12 {

	// SRP

	private WebDriver driver;

	public ElementUtil_12(WebDriver driver) {
		this.driver = driver;
	}
	...
	public By getBy(String locatorType, String locatorValue) {
		...
		default:
			...
			throw new AutomationException_3("WRONG LOCATOR TYPE");
		}
	...
	public Alert waitForJSAlertWithFluentWait(int timeOut, int intervalTime) {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver)
				...
				.ignoring(AutomationException_3.class);
	...
	public WebElement retryingElement(By locator, int timeOut) {
		...
		if (element == null) {
			System.out.println("element is not found....tried for " + timeOut + " times " + " with the interval of "
					+ 500 + " milli seconds ");
			throw new AutomationException_3("No Such Element");
		}
