...
public class BrowserUtil_5 {
	...
	public WebDriver launchBrowser(String browserName) {
		...
		default:
			...
			throw new AutomationException_3("INVALID BROWSER " + browserName);
		}
	...
	public void launchURL(String url) {
		if(url == null) {
			...
			throw new AutomationException_3("NULL URL");
		}
...
//		}
		...
		if(url.indexOf("http")==0) {
			...
			driver.get(url);
				...
				throw new AutomationException_3("HTTP is missing");
